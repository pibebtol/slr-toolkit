...
public class Activator extends TaxonomyActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		URL webRootLocation = Activator.class.getResource("/html/bar.index.html");
		URI webRootUri = URI.create(webRootLocation.toURI().toASCIIString().replaceFirst("/bar.index.html$", "/"));

		Activator.WEB_ROOT_LOCATION = webRootUri.toASCIIString();

		System.out.println("web root location: " + Activator.WEB_ROOT_LOCATION);
		System.out.println("web app workspace: " + Activator.WEB_APP_WORKSPACE);
